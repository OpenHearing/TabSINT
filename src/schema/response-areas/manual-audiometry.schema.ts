...
export const manualAudiometrySchema: JSONSchemaType<ManualAudiometryInterface> = {
  ...
  properties: {
    ...
    adjustmentStepSize: {
      ...
      default: 5,
      description:
        'Specifies the increment or decrement value when adjusting target levels using the plus/minus buttons. Higher values result in larger adjustments per click.',
    },
    incrementRatioMultiplier: {
      ...
      default: 1,
      description:
        'Controls the ratio between positive and negative adjustments. When set to 1, positive and negative buttons make equal adjustments. When set to 2, positive adjustments are twice the magnitude of negative adjustments.',
    },
    retspls: {
      type: 'object',
