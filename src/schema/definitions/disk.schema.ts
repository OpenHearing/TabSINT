  ...
  properties: {
    ...
    availableProtocolsMeta: {
      ...
      properties: {
        ...
        'tabsint-example': protocolMetaSchema,
        'tympan-example': protocolMetaSchema,
        'wahts-example': protocolMetaSchema,
      },
      default: {
        develop: {
        ...
        'tabsint-example': {
          ...
          admin: false,
          creator: 'Creare',
          name: 'tabsint-example',
          path: 'protocols/tabsint-example',
        },
        'tympan-example': {
          date: new Date().toJSON(),
          version: '0.0',
        ...
        'wahts-example': {
          ...
          creator: 'Creare',
          name: 'wahts-example',
          path: 'protocols/wahts-example',
        },
      },
      required: ['develop', 'tabsint-example', 'tympan-example', 'wahts-example'],
    },
