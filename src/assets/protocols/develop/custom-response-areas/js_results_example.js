...
// Logging results
console.log("results:", globalThis.tabsint.resultsModel.getResults());
...
resDisp.innerHTML = JSON.stringify(globalThis.tabsint.resultsModel.getResults().currentPage.page.responseArea.type);
