// PCC battery — selectable results dashboard.
(function () {
  window.tabsint.stateModel.updateState({ isSubmittable: true });

  // Catalog (in the real build this is generated from the registry).
  var tests = [
    { id: 'RAADS', label: 'RAADS' },
    { id: 'QuickQ', label: 'Quick Questionnaire' },
  ];
  ...
  tests.forEach(function (t) {
    ...
    cb.type = 'checkbox'; cb.value = t.id; cb.className = 'pcc-cb';
