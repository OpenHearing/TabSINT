...
@Component({
  selector: 'app-wahts-advanced-settings',
  templateUrl: './wahts-advanced-settings.component.html',
})
export class WahtsAdvancedSettingsComponent implements OnInit, OnDestroy {
