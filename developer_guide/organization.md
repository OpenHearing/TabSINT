...
- `/android`: _(not versioned)_ Build files created after building the app.
...
- `/dist`: The tabsint web application. This is the _web page_ that gets packaged by Capacitor as a native mobile application.
- `/node_modules`: _(not versioned)_ Packages installed by npm
