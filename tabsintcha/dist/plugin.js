var capacitorTabsintCha = (function (exports, core) {
    'use strict';

    const TabsintCha = core.registerPlugin('TabsintCha', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.TabsintChaWeb()),
    });

    class TabsintChaWeb extends core.WebPlugin {
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        TabsintChaWeb: TabsintChaWeb
    });

    exports.TabsintCha = TabsintCha;
